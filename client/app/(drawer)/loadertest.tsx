...
export default function App() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            {result2 && <Text style={{ fontSize: 10 }}>{result2.text}</Text>}

            <Button
                onPress={() => {
                    setLoading(true);
                    launchGallery(setResult, setResult2, setImage, setLoading);
                }}
                title="Start"
            />
        </SafeAreaView>
...
function launchGallery(
    ...
    setResult2: (result2: TextRecognitionResult) => void,
    ...
    launchImageLibrary(
        ...
        async ({ assets }) => {
            ...
            try {
                ...
                setResult2(await TextRecognition.recognize(assets[0].uri));
            } catch (e) {
                console.error(e);
            } finally {
                setLoading(false);
